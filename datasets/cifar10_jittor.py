...
class CIFAR10_LT(object):
    ...
    def __init__(self, distributed, root='./data/cifar10', imb_type='exp',
        ...
        eval_dataset = CIFAR10(root=root, train=False, download=True, transform=eval_transform)
        
        self.cls_num_list = train_dataset.get_cls_num_list()

        self.dist_sampler = None
        self.train_instance = train_dataset.set_attrs(batch_size=batch_size, shuffle=True, num_workers=num_works)
        ...
        """
        self.eval = eval_dataset.set_attrs(batch_size=batch_size, shuffle=False, num_workers=num_works)
